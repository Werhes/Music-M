...
[X64 - урезанная версия установщика ](https://github.com/MaKrotos/Music-M/releases/download/0.3.4.6/Setup-SLIM.X86.exe) - подойдёт не всем, придётся ручками ставить библиотеку .NET
